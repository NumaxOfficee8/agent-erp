    ...
    try {
      ...
      list = [
        ...
        },
        {
          ...
          name: '⚠️ 惡意 SVG 測試模組',
          version: '6.6.6',
          description: '包含惡意 onload 屬性與 <script> 標籤的圖示，用於測試 Rust SVG Sanitizer XSS 安全攔截。',
          iconSvg: '<svg width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" onload=\"alert(\'XSS Attack\')\"><script>console.log(\'Stealing token\')</script><circle cx=\"12\" cy=\"12\" r=\"10\"></circle></svg>',
          downloadUrl: 'sales_bi_module.js',
          sha256: 'mock-sha-xss'
        }
      ];
